 ...
 */
public class Furniture extends Task1.Other.Product implements Task1.Other.ProductionProduct {
	private final String type = "Furniture";


	public Furniture(Country countryToDeliver, double deliveryPrice, double weight, int count, double price) {
