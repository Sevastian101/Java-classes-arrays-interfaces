 ...
 */
public class Toys extends Task1.Other.Product implements Task1.Other.ProductionProduct {

	private final String type = "Toys";

	public Toys(Country countryToDeliver, double deliveryPrice, double weight, int count, double price) {
